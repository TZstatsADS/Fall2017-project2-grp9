...
shinyServer(function(input, output) {
  ...
  output$instruction3 = renderText({
    "3. choose the location, major, city size, school type and highest degree you would like. If you don't have preference, please leave them as blank."
  })
  output$instruction4 = renderText({
    "4. Finishing step 1-3, the universities that fit you with infomation you may need will show on the table. By clicking each row of the table, a red pin in the map pops up to show its location.  "
  })
